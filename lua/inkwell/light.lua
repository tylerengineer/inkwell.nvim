...
function M.setup(c)
    ...
    vim.g.colors_name = 'inkwell-light'

    local set = vim.api.nvim_set_hl

    set(0, 'Normal', { fg = c.fg, bg = c.bg })
    set(0, 'LineNr', { fg = c.tan })
    set(0, 'CursorLineNr', { fg = c.bark, bold = true })
    set(0, 'Visual', { bg = c.jade })
    set(0, 'StatusLine', { fg = c.bg, bg = c.bark })
    set(0, 'VertSplit', { fg = c.tan })
    set(0, 'Pmenu', { bg = c.linen, fg = c.fg })
    set(0, 'PmenuSel', { bg = c.jade, fg = c.bg })
    set(0, 'Search', { bg = c.mint, fg = c.ink })

    set(0, 'Comment', { fg = c.tan, italic = true })
    set(0, 'Constant', { fg = c.mint })
    set(0, 'String', { fg = c.jade })
    set(0, 'Function', { fg = c.bark, bold = true })
    set(0, 'Keyword', { fg = c.ink, italic = true })
